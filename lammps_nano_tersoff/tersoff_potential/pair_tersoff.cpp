                         ...
                         double *rij_hat, double *rik_hat)
{
  ...
  return ters_fc_zeta(rik,param) * ters_gijk(costheta,param) * ex_delr;
}
...
double PairTersoff::ters_fc_zeta(double r, Param *param)
{
  double ters_R = 0.6641942329530246; //param->bigr;
  double ters_D = 0.6822159285607508; //param->bigd;
...
double PairTersoff::ters_fc_zeta_d(double r, Param *param)
{
  double ters_R = 0.6641942329530246;//param->bigr;
  double ters_D = 0.6822159285607508;//param->bigd;
                                  ...
                                  Param *param)
{
  ...
  fc = ters_fc_zeta(rik,param);
  dfc = ters_fc_zeta_d(rik,param);
